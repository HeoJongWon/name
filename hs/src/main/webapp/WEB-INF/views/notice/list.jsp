			            ...
			            <div class="col-auto">
							<c:if test="${dataCount != 0}">
								<select name="size" class="form-select" onchange="changeList();">
									<option value="5" ${size==5 ? "selected":""}>5개출력</option>
									<option value="10" ${size==10 ? "selected":""}>10개출력</option>
									<option value="20" ${size==20 ? "selected":""}>20개출력</option>
									<option value="30" ${size==30 ? "selected":""}>30개출력</option>
									<option value="50" ${size==50 ? "selected":""}>50개출력</option>
								</select>
							</c:if>
