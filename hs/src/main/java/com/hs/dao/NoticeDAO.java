...
public class NoticeDAO {
	...
	public NoticeDTO findById(long num) {
		...
		try {
			sql = "SELECT num, n.userId, notice, userName, subject, content, reg_date, hitCount " + " FROM notice n "
					+ " JOIN member1 m ON n.userId=m.userId " + " WHERE num = ? ";
	...
	public void deleteNoteice(long num)throws SQLException{
		PreparedStatement pstmt = null;
		String sql;
	...
	public void deleteNoteice(long[] nums)throws SQLException{
		PreparedStatement pstmt = null;
		String sql;
